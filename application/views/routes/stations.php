...
<div class="container-fluid">
        ...
        <div class="col-md-12 text-center">    
            <div style="min-height: 400px;padding-bottom: 100px;padding-top: 200px;">
                ...
                $point_price = array(
                 ...
                 echo anchor('route/add_station/' . $rcode . '/' . $vtid, '<i class="fa fa-bus" ></i>  จุดจอดและอัตราค่าโดยสาร', $point_price);
                ?>             
    ...
    <div class="row" >
        <div class="col-md-12 text-right">            
            <a class="btn btn-success" ><span class="fa fa-stop">  เพิ่มจุดจอด</span></a>
